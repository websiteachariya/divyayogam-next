...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-[#47206A] flex flex-col justify-between relative overflow-x-hidden font-body">
      ...
      <main className="relative z-10 py-8 sm:py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full flex-1 space-y-8">
        {/* Admin Header */}
        <div className="bg-gradient-to-r from-[#47206A]/95 via-[#3B104E]/95 to-[#20052C]/95 rounded-3xl border-2 border-[#DFC47A] p-6 sm:p-8 text-white shadow-2xl backdrop-blur-md flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
        ...
        <div className="flex items-center gap-2 pb-2 overflow-x-auto">
          <button
            ...
            className={`px-5 py-2.5 rounded-full font-bold text-xs uppercase tracking-wider transition-all whitespace-nowrap cursor-pointer ${
              activeTab === 'overview'
                ? 'bg-[#47206A] text-[#DFC47A] shadow-md border-2 border-[#DFC47A]'
                : 'bg-white/80 text-[#47206A] hover:bg-white border border-[#DFC47A]/40 backdrop-blur-sm'
            }`}
          >
            Overview & Metrics
          </button>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="p-6 rounded-3xl bg-white/85 backdrop-blur-md border-2 border-[#DFC47A]/60 shadow-lg space-y-2 hover:shadow-xl transition-all">
            ...
            <div className="bg-white/85 backdrop-blur-md rounded-3xl border-2 border-[#DFC47A]/60 p-6 sm:p-8 shadow-xl space-y-4">
              <h2 className="text-xl font-extrabold font-heading text-[#47206A] border-b border-gray-200/80 pb-3">
                Revenue Breakdown by Category
              </h2>

              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-4 rounded-2xl bg-[#FAF7F2]/80 backdrop-blur-sm border border-[#E9DED3]">
        ...
        {activeTab === 'users' && (
          <div className="bg-white/85 backdrop-blur-md rounded-3xl border-2 border-[#DFC47A]/60 p-6 sm:p-8 shadow-xl space-y-6">
            ...
            {/* User Filter Toolbar */}
            <div className="p-4 rounded-2xl bg-[#FAF7F2]/80 backdrop-blur-sm border border-[#E9DED3] space-y-3">
        ...
        {/* TAB 3: CASHFREE ORDERS & TRANSACTIONS */}
        {activeTab === 'orders' && (
          <div className="bg-white/85 backdrop-blur-md rounded-3xl border-2 border-[#DFC47A]/60 p-6 sm:p-8 shadow-xl space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-gray-100 pb-4">
              <h2 className="text-xl font-extrabold font-heading text-[#47206A]">
