...
export default function WellnessServicesPage() {
  ...
  return (
    <div className="bg-transparent font-body min-h-screen relative overflow-x-hidden">
      ...
      <header className="relative bg-gradient-to-b from-[#351A4A] via-[#2A133B] to-[#200D2E] pt-28 sm:pt-32 md:pt-36 lg:pt-44 pb-10 sm:pb-14 lg:pb-16 text-center text-white overflow-hidden font-body">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 space-y-4 sm:space-y-5">
          <motion.div
          ...
          <motion.h1
            ...
            className="font-heading text-3xl sm:text-5xl lg:text-7xl font-extrabold leading-tight text-white drop-shadow-md"
          >
          ...
          <motion.p
            ...
            className="font-serif italic text-base sm:text-xl lg:text-2xl text-[#F8F2E8] max-w-2xl mx-auto leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 sm:gap-3 px-5 py-2 sm:px-6 sm:py-2.5 rounded-full bg-[#C8A34A] text-[#352043] font-heading font-extrabold text-[11px] sm:text-xs md:text-sm uppercase tracking-wider shadow-lg"
          >
            <Sun className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#352043]" />
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6 sm:space-y-8 lg:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <span className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#352043] text-[#DFC47A] border border-[#DFC47A]/40 text-[11px] sm:text-xs font-bold uppercase tracking-widest shadow-md">
            ...
            <p className="text-[#5E5865] text-xs sm:text-sm lg:text-base font-normal max-w-xl mx-auto">
            ...
            {purposes.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white/95 rounded-3xl p-5 sm:p-6 lg:p-8 border-2 border-[#E9DED3] shadow-lg hover:shadow-2xl hover:border-[#8C5D00] hover:-translate-y-1.5 transition-all duration-300 space-y-3 sm:space-y-4 text-center group"
                >
                  <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl bg-[#352043] text-[#DFC47A] border border-[#DFC47A]/40 flex items-center justify-center mx-auto shadow-md group-hover:scale-110 transition-transform">
                    <IconComp className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8" />
                  </div>
                  <h3 className="font-heading text-lg sm:text-xl font-extrabold text-[#352043]">
                    {item.title}
                  </h3>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent border-t border-[#DFC47A]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6 sm:space-y-8 lg:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <span className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#352043] text-[#DFC47A] border border-[#DFC47A]/40 text-[11px] sm:text-xs font-bold uppercase tracking-widest shadow-md">
            ...
            <p className="text-[#5E5865] text-xs sm:text-sm lg:text-base font-normal max-w-2xl mx-auto">
            ...
            {approaches.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white/95 rounded-3xl p-4 sm:p-5 lg:p-6 border-2 border-[#E9DED3] shadow-md hover:shadow-xl transition-all space-y-2 sm:space-y-3 flex items-start gap-3 sm:gap-4"
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[#FAF5EF] text-[#8C5D00] border border-[#DFC47A]/50 flex items-center justify-center shrink-0 shadow-xs">
                    <IconComp className="w-5 h-5 sm:w-6 sm:h-6" />
                  </div>
                  <div className="space-y-1">
                    <h4 className="font-heading text-sm sm:text-base font-extrabold text-[#352043]">
                      {item.title}
                    </h4>
            ...
            {services.map((srv, idx) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: idx * 0.08 }}
                  className="bg-white/95 rounded-3xl p-5 sm:p-6 lg:p-7 border-2 border-[#E9DED3] shadow-lg hover:shadow-2xl hover:border-[#8C5D00] hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between space-y-4 sm:space-y-5 group"
                >
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full bg-[#FAF5EF] text-[#8C5D00] border border-[#DFC47A]/50 text-[10px] font-extrabold uppercase tracking-wider">
                        <IconComp className="w-3.5 h-3.5 text-[#8C5D00]" />
                        <span>{srv.badge}</span>
                      </span>
                      <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#352043] text-[#DFC47A] flex items-center justify-center shadow-xs">
                        <IconComp className="w-4.5 h-4.5 sm:w-5 sm:h-5" />
                      </div>
                    </div>
                    <h3 className="font-heading text-lg sm:text-xl font-extrabold text-[#352043] group-hover:text-[#8C5D00] transition-colors">
                      {srv.title}
                    </h3>
                    <p className="text-[#5E5865] text-xs sm:text-sm leading-relaxed font-normal">
                      {srv.desc}
      ...
      <section
        className="py-8 sm:py-12 md:py-16 lg:py-20 text-white relative overflow-hidden bg-cover bg-center w-full"
        style={{
          backgroundImage:
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6 sm:space-y-8 lg:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <span className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#C8A34A]/20 border border-[#DFC47A]/40 text-[#DFC47A] text-[11px] sm:text-xs font-bold uppercase tracking-widest shadow-md">
              <Clock className="w-3.5 h-3.5 text-[#DFC47A]" />
              LIFE STAGE WELLNESS
            </span>
            <h2 className="font-heading text-2xl sm:text-4xl lg:text-5xl font-extrabold text-white">
              A Wellness Journey For <span className="font-serif italic font-normal text-[#DFC47A]">Every Stage of Life</span>
            </h2>
            <p className="text-[#F8F2E8]/90 text-xs sm:text-sm lg:text-base font-serif italic max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6">
            {stages.map((stg, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: idx * 0.08 }}
                className="bg-white/10 border border-[#DFC47A]/40 rounded-3xl p-4 sm:p-5 lg:p-6 text-center space-y-3 backdrop-blur-md hover:bg-white/20 transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="font-heading text-xl sm:text-2xl font-extrabold text-white">
                    {stg.stage}
                  </div>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 space-y-6 sm:space-y-8 lg:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <span className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#352043] text-[#DFC47A] border border-[#DFC47A]/40 text-[11px] sm:text-xs font-bold uppercase tracking-widest shadow-md">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 text-center">
            <div className="bg-white/95 rounded-2xl p-4 sm:p-5 border border-[#E9DED3] shadow-md space-y-1.5 sm:space-y-2">
              <span className="font-heading font-extrabold text-xl sm:text-2xl text-[#8C5D00] block">Health</span>
              <p className="text-xs text-[#5E5865]">Caring for the body creates a foundation for well-being.</p>
            </div>
            <div className="bg-white/95 rounded-2xl p-4 sm:p-5 border border-[#E9DED3] shadow-md space-y-1.5 sm:space-y-2">
              <span className="font-heading font-extrabold text-xl sm:text-2xl text-[#8C5D00] block">Happiness</span>
              <p className="text-xs text-[#5E5865]">A peaceful, clear mind experiences greater happiness.</p>
            </div>
            <div className="bg-white/95 rounded-2xl p-4 sm:p-5 border border-[#E9DED3] shadow-md space-y-1.5 sm:space-y-2">
              <span className="font-heading font-extrabold text-xl sm:text-2xl text-[#8C5D00] block">Purpose</span>
              <p className="text-xs text-[#5E5865]">Happiness aligned with purpose reveals deeper meaning.</p>
            </div>
            <div className="bg-white/95 rounded-2xl p-4 sm:p-5 border border-[#E9DED3] shadow-md space-y-1.5 sm:space-y-2">
              <span className="font-heading font-extrabold text-xl sm:text-2xl text-[#C8A34A] block">Potential</span>
              <p className="text-xs text-[#5E5865]">Purpose-guided actions unlock our highest potential.</p>
            </div>
          </div>

          <div className="bg-white p-5 sm:p-6 rounded-3xl border-2 border-[#DFC47A] shadow-xl text-center max-w-3xl mx-auto space-y-2">
            <p className="font-serif italic text-sm sm:text-base lg:text-lg text-[#352043] leading-relaxed">
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent border-t border-[#DFC47A]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6 sm:space-y-8 lg:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            ...
            <p className="text-base sm:text-lg font-serif italic text-[#8C5D00] font-semibold">
              Pause. Breathe. Reconnect. Heal.
            </p>
            <p className="text-[#5E5865] text-xs sm:text-sm lg:text-base max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            <div className="bg-white/95 rounded-3xl p-4 sm:p-5 lg:p-6 border-2 border-[#E9DED3] shadow-md text-center space-y-2 sm:space-y-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[#FAF5EF] text-[#8C5D00] border border-[#DFC47A]/50 flex items-center justify-center mx-auto shadow-xs">
                <ShieldCheck className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <span className="font-heading text-lg sm:text-xl font-extrabold text-[#352043] block">Clean</span>
            ...
            <div className="bg-white/95 rounded-3xl p-4 sm:p-5 lg:p-6 border-2 border-[#E9DED3] shadow-md text-center space-y-2 sm:space-y-3">
              ...
              <span className="font-heading text-lg sm:text-xl font-extrabold text-[#352043] block">Calm</span>
            ...
            <div className="bg-white/95 rounded-3xl p-4 sm:p-5 lg:p-6 border-2 border-[#E9DED3] shadow-md text-center space-y-2 sm:space-y-3">
              ...
              <span className="font-heading text-lg sm:text-xl font-extrabold text-[#352043] block">Natural</span>
            ...
            <div className="bg-white/95 rounded-3xl p-4 sm:p-5 lg:p-6 border-2 border-[#E9DED3] shadow-md text-center space-y-2 sm:space-y-3">
              ...
              <span className="font-heading text-lg sm:text-xl font-extrabold text-[#352043] block">Sacred</span>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent border-t border-[#DFC47A]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6 sm:space-y-8 lg:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            ...
            <p className="text-[#5E5865] text-xs sm:text-sm lg:text-base max-w-xl mx-auto">
            ...
            {pillars.map((plr, idx) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: idx * 0.08 }}
                  className="bg-white/95 rounded-3xl p-4 sm:p-5 lg:p-7 border-2 border-[#E9DED3] shadow-lg text-center space-y-3 sm:space-y-4 hover:shadow-2xl hover:border-[#8C5D00] transition-all group"
                >
                  <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl bg-[#352043] text-[#DFC47A] border border-[#DFC47A]/40 flex items-center justify-center mx-auto shadow-md group-hover:scale-110 transition-transform">
                    <IconComp className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-[#DFC47A]" />
                  </div>
                  <h3 className="font-heading text-lg sm:text-xl font-extrabold text-[#352043]">
                    {plr.name}
                  </h3>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent border-t border-[#DFC47A]/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 space-y-6 sm:space-y-8 lg:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            ...
            <p className="font-heading text-xs sm:text-sm lg:text-base font-bold text-[#8C5D00] uppercase tracking-wider">
          ...
          <div className="space-y-2.5 sm:space-y-3 max-w-3xl mx-auto">
            {dailySteps.map((stp, idx) => (
              <div key={idx} className="flex items-center gap-3 sm:gap-4 bg-white/95 p-3 sm:p-4 rounded-2xl border border-[#E9DED3] shadow-xs">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#352043] text-[#DFC47A] font-extrabold text-xs sm:text-sm flex items-center justify-center shrink-0">
                  {stp.step}
                </div>
                <div className="space-y-0.5">
                  <h4 className="font-heading font-extrabold text-xs sm:text-sm text-[#352043]">{stp.title}</h4>
                  <p className="text-[11px] sm:text-xs text-[#5E5865]">{stp.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* 10. WHY DIVINE GRACE? */}
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent border-t border-[#DFC47A]/30">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 text-center space-y-6 sm:space-y-8">
          <div className="space-y-2 sm:space-y-3 max-w-3xl mx-auto">
            ...
            <p className="font-serif italic text-base sm:text-lg text-[#5E5865]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 sm:gap-3 lg:gap-4">
            <div className="bg-white p-3 sm:p-4 rounded-2xl border border-[#E9DED3] shadow-xs font-bold text-[10px] sm:text-xs text-[#352043] uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2">
              <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#8C5D00]" />
              <span>Vitality</span>
            </div>
            <div className="bg-white p-3 sm:p-4 rounded-2xl border border-[#E9DED3] shadow-xs font-bold text-[10px] sm:text-xs text-[#352043] uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2">
              <Sun className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#8C5D00]" />
              <span>Clarity</span>
            </div>
            <div className="bg-white p-3 sm:p-4 rounded-2xl border border-[#E9DED3] shadow-xs font-bold text-[10px] sm:text-xs text-[#352043] uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2">
              <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#8C5D00]" />
              <span>Emotional Harmony</span>
            </div>
            <div className="bg-white p-3 sm:p-4 rounded-2xl border border-[#E9DED3] shadow-xs font-bold text-[10px] sm:text-xs text-[#352043] uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2">
              <Flower2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#8C5D00]" />
              <span>Inner Peace</span>
            </div>
            <div className="bg-white p-3 sm:p-4 rounded-2xl border border-[#E9DED3] shadow-xs font-bold text-[10px] sm:text-xs text-[#352043] uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2 col-span-2 sm:col-span-1">
              <Compass className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#8C5D00]" />
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden bg-transparent">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div
            className="rounded-3xl p-6 sm:p-10 lg:p-14 text-white border-2 border-[#DFC47A] shadow-2xl text-center space-y-5 sm:space-y-8 bg-cover bg-center overflow-hidden relative"
            style={{
              backgroundImage:
                "linear-gradient(135deg, rgba(100, 40, 127, 0.95) 0%, rgba(64, 25, 82, 0.98) 100%), url('/images/qh-1.webp')",
            }}
          >
            <span className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#C8A34A]/20 border border-[#DFC47A]/40 text-[#DFC47A] text-[11px] sm:text-xs font-bold uppercase tracking-widest">
            ...
            <div className="space-y-1 font-serif italic text-sm sm:text-lg lg:text-xl text-[#F8F2E8]/90 max-w-xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 pt-2">
              <Link
                href="/contact"
                className="px-6 py-3 sm:px-7 sm:py-3.5 rounded-full bg-[#C8A34A] hover:bg-white text-[#352043] font-extrabold text-xs sm:text-sm uppercase tracking-wider shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
              ...
              <Link
                href="/contact"
                className="px-6 py-3 sm:px-7 sm:py-3.5 rounded-full bg-white/10 hover:bg-white/20 border border-[#DFC47A]/50 text-[#DFC47A] hover:text-white font-bold text-xs sm:text-sm uppercase tracking-wider backdrop-blur-md transition-all duration-300"
              >
                <span>Book a Consultation</span>
              </Link>
            </div>

            <div className="border-t border-white/20 pt-4 sm:pt-6 space-y-1 text-xs text-[#DFC47A] font-heading font-extrabold uppercase tracking-widest">
              <p>DIVINE GRACE: Divya Yogam</p>
              <p className="text-white/80 font-normal text-[10px] sm:text-[11px] capitalize tracking-normal">
