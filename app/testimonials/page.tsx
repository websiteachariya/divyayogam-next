  ...
  return (
    <div className="bg-transparent font-body min-h-screen relative">
      ...
      <header className="relative bg-gradient-to-b from-[#351A4A] via-[#2A133B] to-[#200D2E] pt-32 pb-24 text-center text-white overflow-hidden">
        ...
        <div className="absolute top-1/2 left-0 -translate-y-1/2 opacity-35 sm:opacity-60 md:opacity-85 pointer-events-none w-32 h-32 sm:w-52 sm:h-52 md:w-72 md:h-72 lg:w-96 lg:h-96 xl:w-[420px] xl:h-[420px] -translate-x-1/6 sm:translate-x-0 transition-all duration-300">
          <Image
        ...
        <div className="absolute top-1/2 right-0 -translate-y-1/2 opacity-35 sm:opacity-60 md:opacity-85 pointer-events-none w-32 h-32 sm:w-52 sm:h-52 md:w-72 md:h-72 lg:w-96 lg:h-96 xl:w-[420px] xl:h-[420px] translate-x-1/6 sm:translate-x-0 scale-x-[-1] transition-all duration-300">
          <Image
            src="/images/test-1.webp"
