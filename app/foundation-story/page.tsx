...
export default function FoundationStoryPage() {
  ...
  return (
    <div className="bg-[#FAF7F2] font-body min-h-screen text-[#352043] relative overflow-hidden">
      ...
      {/* ======================================================================== */}
      <header className="relative bg-gradient-to-b from-[#2B083A] via-[#3B104E] to-[#20052C] pt-36 sm:pt-40 md:pt-44 lg:pt-48 pb-14 sm:pb-18 lg:pb-20 text-center text-white overflow-hidden font-body">
