...
const defaultSiteRoutesData: RouteSeoData[] = [
  ...
  {
    path: '/happy-shambhala',
    name: 'Happy Shambhala Page',
    category: 'Memberships',
    title: 'Happy Shambhala — Divine Consciousness & Rejuvenation | Divya Yogam',
    description: 'Experience Happy Shambhala, a sacred journey into cellular healing, organ meditation, and high-vibrational living under Master Arawindhan Ji.',
    keywords: ['Happy Shambhala', 'Divya Yogam', 'Cellular Rejuvenation', 'Organ Meditation', 'Arawindhan Ji'],
